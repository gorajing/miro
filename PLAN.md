...
- **Assets** — `demo/assets/miro-clean.png` (clean no-text render), `demo/assets/miro-sprite.png` (transparent sprite), regenerated by `npm run render:miro`
...
```bash
npm run dev          # Vite on 127.0.0.1:5173: /app.html · /race.html · / (art preview)
npm run overlay      # second terminal: Electron desktop overlay — she lives on your screen
npm run render:miro  # regenerate the clean Miro PNG assets
